...
/**
 * Servlet implementation class VotoAJAX
 */
@WebServlet("/VotoAJAX")
public class VotoAJAX extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Candidato candidato = candidatoDAO.obterPorNumeroCandidato(numero);
        JSONObject json = new JSONObject();
        
        try {
            if(candidato != null) {
            	json.put("respostaServidor", candidato.getNome());
            }

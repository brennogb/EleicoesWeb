  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="limpaMensagemErro();">
        ...
        <form class="" method="post" action="Logar" onsubmit="return validaFormLogin();">
	      <div class="modal-body">
		    <input type="text" id="email" name="email" placeholder="Email" class="form-control mt-2" onfocus="limpaMensagemErro();">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="limpaMensagemErro();">Cancelar</button>
	      </div>
		</form>
    </div>
  </div>
